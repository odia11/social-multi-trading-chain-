    ...
    def _messages_premium_ui(response):
        try:
            ...
            if 'messages-composer-v4.css' not in body and '</head>' in body:
                body = body.replace('</head>', '<link rel="stylesheet" href="/static/messages-composer-v4.css?v=2">\n</head>', 1)
            ...
            if 'messages-composer-v4.js' not in body and '</body>' in body:
                body = body.replace('</body>', '<script src="/static/messages-composer-v4.js?v=2" defer></script>\n</body>', 1)
