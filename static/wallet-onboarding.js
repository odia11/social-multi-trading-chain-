...
function modal(){
  ...
  m.innerHTML='<div class="oa-ob-card" role="dialog" aria-modal="true" aria-label="Wallet setup"><div class="oa-ob-handle"></div><button class="oa-ob-close" aria-label="Close">×</button><div class="oa-ob-intro"><div class="oa-ob-brand">ORCAGENT</div><h2>Set up your wallet</h2><p class="oa-ob-sub">Create a secure OrcAgent wallet or use one you already own.</p></div><div class="oa-ob-actions"><button class="oa-ob-primary" data-action="create"><strong>Create New Wallet</strong><span>Generate a self-custodial wallet securely on this device.</span></button><button class="oa-ob-secondary" data-action="import"><strong>Import Existing Wallet</strong><span>Use your existing Solana private key.</span></button><button class="oa-ob-secondary" data-action="phantom"><strong>Connect Phantom</strong><span>Continue with the wallet in your Phantom app.</span></button></div><div class="oa-ob-stage" hidden></div></div>';
